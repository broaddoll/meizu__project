...
class menu {
    ...
    state() {
        ...
        if (user_str) {
            ...
            // 删除小人
            $('#ren').remove();
            $('#personal').append(`<img src="../img/wpy-touxiang.png" alt="" id="touxiang"  style="width:29px;height:29px;border-radius: 50px;">`);
            // 获取商品的cookie
            ...
            // 没账号，点击购物车 跳转到购物车的登陆页面
            $('#gwctz').attr('href','car-login.html');
        }
    }
    strtoobj(str) {
        if (!str) {
